...
testOneFile libdir fileName = do
    ...
    where
     ...
     doRuleDecl :: RuleDecl GhcPs
                -> [(String,[String])]
     doRuleDecl (HsRule _ _ (ActiveBefore (SourceText ss) _) _ _ _ _ _)
       = [("rb",[ss])]
     doRuleDecl (HsRule _ _ (ActiveAfter (SourceText ss) _) _ _ _ _ _)
       = [("ra",[ss])]
     doRuleDecl (HsRule _ _ _ _ _ _ _ _) = []
