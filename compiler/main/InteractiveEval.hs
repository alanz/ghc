...
parseImportDecl :: GhcMonad m => String -> m (ImportDecl GHCP)
...
parseExpr :: GhcMonad m => String -> m (LHsExpr GHCP)
...
compileParsedExprRemote :: GhcMonad m => LHsExpr GHCP -> m ForeignHValue
...
compileParsedExpr :: GhcMonad m => LHsExpr GHCP -> m HValue
