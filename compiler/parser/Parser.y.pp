...
module :: { Located (HsModule RdrName) }
       : maybedocheader 'module' modid maybemodwarning maybeexports 'where' body
             {% fileSrcSpan >>= \ loc ->
                ams (L loc (HsModule (Just $3) (snd $5) (fst $ snd $7)
                              (snd $ snd $7) (snd $4) $1)
                    )
                    ((fst $5) ++ [mj AnnModule $2, mj AnnWhere $6]
                              ++ fst $4 ++ fst $7) }
        | body2
                {% fileSrcSpan >>= \ loc ->
...
header  :: { Located (HsModule RdrName) }
        : maybedocheader 'module' modid maybemodwarning maybeexports 'where' header_body
                {% fileSrcSpan >>= \ loc ->
                   ams (L loc (HsModule (Just $3) (snd $5) $7 [] (snd $4) $1
                          )) (mj AnnModule $2:mj AnnWhere $6:(fst $5)) }
        | header_body2
                {% fileSrcSpan >>= \ loc ->
...
maybeexports :: { ([MaybeAnn],Maybe [LIE RdrName]) }
        :  '(' exportlist ')'       { ([mo $1,mc $3],Just (fromOL $2)) }
        |  {- empty -}              { ([],Nothing) }
