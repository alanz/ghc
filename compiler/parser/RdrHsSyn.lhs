...
\begin{code}
mkTyClD :: LTyClDecl n ptt -> LHsDecl n ptt
mkTyClD (L loc d) = L loc (TyClD d)

mkInstD :: LInstDecl n ptt -> LHsDecl n ptt
mkInstD (L loc d) = L loc (InstD d)

mkClassDecl :: SrcSpan
            -> Located (Maybe (LHsContext RdrName PreTcType), LHsType RdrName PreTcType)
            -> Located [Located (FunDep RdrName)]
            -> Located (OrdList (LHsDecl RdrName PreTcType))
            -> P (LTyClDecl RdrName PreTcType)
...
mkATDefault :: LTyFamInstDecl RdrName PreTcType
            -> Either (SrcSpan, SDoc) (LTyFamDefltEqn RdrName PreTcType)
...
mkTyData :: SrcSpan
         ...
         -> Maybe CType
         -> Located (Maybe (LHsContext RdrName PreTcType), LHsType RdrName PreTcType)
         -> Maybe (LHsKind RdrName PreTcType)
         -> [LConDecl RdrName PreTcType]
         -> Maybe [LHsType RdrName PreTcType]
         -> P (LTyClDecl RdrName PreTcType)
...
mkDataDefn :: NewOrData
           -> Maybe CType
           -> Maybe (LHsContext RdrName PreTcType)
           -> Maybe (LHsKind RdrName PreTcType)
           -> [LConDecl RdrName PreTcType]
           -> Maybe [LHsType RdrName PreTcType]
           -> P (HsDataDefn RdrName PreTcType)
...
mkTySynonym :: SrcSpan
            -> LHsType RdrName PreTcType  -- LHS
            -> LHsType RdrName PreTcType -- RHS
            -> P (LTyClDecl RdrName PreTcType)
...
mkTyFamInstEqn :: LHsType RdrName PreTcType
               -> LHsType RdrName PreTcType
               -> P (TyFamInstEqn RdrName PreTcType)
...
mkTyFamInst :: SrcSpan
            -> LTyFamInstEqn RdrName PreTcType
            -> P (LInstDecl RdrName PreTcType)
mkTyFamInst loc eqn
...
mkFamDecl :: SrcSpan
          -> FamilyInfo RdrName PreTcType
          -> LHsType RdrName PreTcType   -- LHS
          -> Maybe (LHsKind RdrName PreTcType) -- Optional kind signature
          -> P (LTyClDecl RdrName PreTcType)
...
mkSpliceDecl :: LHsExpr RdrName PreTcType -> HsDecl RdrName PreTcType
-- If the user wrote
...
mkTyLit :: Located (HsTyLit) -> P (LHsType RdrName PreTcType)
mkTyLit l =
...
cvTopDecls :: OrdList (LHsDecl RdrName PreTcType) -> [LHsDecl RdrName PreTcType]
cvTopDecls decls = go (fromOL decls)
  where
    go :: [LHsDecl RdrName PreTcType] -> [LHsDecl RdrName PreTcType]
    go []                   = []
...
cvBindGroup :: OrdList (LHsDecl RdrName PreTcType) -> HsValBinds RdrName PreTcType
cvBindGroup binding
...
cvBindsAndSigs :: OrdList (LHsDecl RdrName PreTcType)
  -> (LHsBinds RdrName PreTcType, [LSig RdrName PreTcType], [LFamilyDecl RdrName PreTcType]
          , [LTyFamInstDecl RdrName PreTcType], [LDataFamInstDecl RdrName PreTcType], [LDocDecl])
...
getMonoBind :: LHsBind RdrName PreTcType -> [LHsDecl RdrName PreTcType]
  -> (LHsBind RdrName PreTcType, [LHsDecl RdrName PreTcType])
...
has_args :: [LMatch RdrName (LHsExpr RdrName PreTcType) PreTcType] -> Bool
...
splitCon :: LHsType RdrName PreTcType
      -> P (Located RdrName, HsConDeclDetails RdrName PreTcType)
...
splitPatSyn :: LPat RdrName PreTcType
...
splitPatSyn pat@(L loc (ConPatIn con details)) = do
    ...
    return (con, details')
  where
    patVar :: LPat RdrName PreTcType-> P (Located RdrName)
...
recordPatSynErr :: SrcSpan -> LPat RdrName PreTcType -> P a
recordPatSynErr loc pat =
    parseErrorSDoc loc $
    text "record syntax not supported for pattern synonym declarations:" $$
    ppr pat

toPatSynMatchGroup :: Located RdrName -> Located (OrdList (LHsDecl RdrName PreTcType))
  -> P (MatchGroup RdrName (LHsExpr RdrName PreTcType) PreTcType)
...
mkDeprecatedGadtRecordDecl :: SrcSpan
                           -> Located RdrName
                           -> [ConDeclField RdrName PreTcType]
                           -> LHsType RdrName PreTcType
                           ->  P (LConDecl RdrName PreTcType)
...
mkSimpleConDecl :: Located RdrName -> [LHsTyVarBndr RdrName PreTcType]
                -> LHsContext RdrName PreTcType -> HsConDeclDetails RdrName PreTcType
                -> ConDecl RdrName PreTcType
...
mkGadtDecl :: [Located RdrName]
           -> LHsType RdrName PreTcType     -- Always a HsForAllTy
           -> [ConDecl RdrName PreTcType]
-- We allow C,D :: ty
...
\begin{code}
checkTyVarsP :: SDoc -> SDoc -> Located RdrName -> [LHsType RdrName PreTcType]
  -> P (LHsTyVarBndrs RdrName PreTcType)
...
checkTyVars :: SDoc -> SDoc -> Located RdrName -> [LHsType RdrName PreTcType] 
            -> Either (SrcSpan, SDoc) (LHsTyVarBndrs RdrName PreTcType)
...
checkDatatypeContext :: Maybe (LHsContext RdrName PreTcType) -> P ()
...
checkTyClHdr :: LHsType RdrName PreTcType
             -> P (Located RdrName,             -- the head symbol (type or class name)
                   [LHsType RdrName PreTcType]) -- parameters of head symbol
...
checkContext :: LHsType RdrName PreTcType -> P (LHsContext RdrName PreTcType)
...
checkPattern :: SDoc -> LHsExpr RdrName PreTcType -> P (LPat RdrName PreTcType)
checkPattern msg e = checkLPat msg e

checkPatterns :: SDoc -> [LHsExpr RdrName PreTcType] -> P [LPat RdrName PreTcType]
checkPatterns msg es = mapM (checkPattern msg) es

checkLPat :: SDoc -> LHsExpr RdrName PreTcType -> P (LPat RdrName PreTcType)
checkLPat msg e@(L l _) = checkPat msg l e []

checkPat :: SDoc -> SrcSpan -> LHsExpr RdrName PreTcType -> [LPat RdrName PreTcType]
         -> P (LPat RdrName PreTcType)
...
checkAPat :: SDoc -> SrcSpan -> HsExpr RdrName PreTcType -> P (Pat RdrName PreTcType)
...
placeHolderPunRhs :: LHsExpr RdrName PreTcType
...
checkPatField :: SDoc -> HsRecField RdrName (LHsExpr RdrName PreTcType)
  -> P (HsRecField RdrName (LPat RdrName PreTcType))
checkPatField msg fld = do p <- checkLPat msg (hsRecFieldArg fld)
                           return (fld { hsRecFieldArg = p })

patFail :: SDoc -> SrcSpan -> HsExpr RdrName PreTcType -> P a
...
checkValDef :: SDoc
            ...
            -> Maybe (LHsType RdrName PreTcType)
            -> Located (GRHSs RdrName (LHsExpr RdrName PreTcType) PreTcType)
            -> P (HsBind RdrName PreTcType)
...
makeFunBind :: (PlaceHolderType ptt) => Located id -> Bool -> [LMatch id (LHsExpr id ptt) ptt] -> HsBind id ptt
...
checkDoAndIfThenElse :: LHsExpr RdrName PreTcType
                     -> Bool
                     -> LHsExpr RdrName PreTcType
                     -> Bool
                     -> LHsExpr RdrName PreTcType
...
splitBang :: LHsExpr RdrName PreTcType -> Maybe (LHsExpr RdrName PreTcType, [LHsExpr RdrName PreTcType])
...
isFunLhs :: LHsExpr RdrName PreTcType
         -> P (Maybe (Located RdrName, Bool, [LHsExpr RdrName PreTcType]))
...
checkCommand :: LHsExpr RdrName PreTcType -> P (LHsCmd RdrName PreTcType)
checkCommand lc = locMap checkCmd lc

locMap :: (SrcSpan -> a -> P b) -> Located a -> P (Located b)
locMap f (L l a) = f l a >>= (\b -> return $ L l b)

checkCmd :: SrcSpan -> HsExpr RdrName PreTcType -> P (HsCmd RdrName PreTcType)
...
checkCmdLStmt :: ExprLStmt RdrName PreTcType -> P (CmdLStmt RdrName PreTcType)
checkCmdLStmt = locMap checkCmdStmt

checkCmdStmt :: SrcSpan -> ExprStmt RdrName PreTcType -> P (CmdStmt RdrName PreTcType)
...
checkCmdMatchGroup :: MatchGroup RdrName (LHsExpr RdrName PreTcType) PreTcType
  -> P (MatchGroup RdrName (LHsCmd RdrName PreTcType) PreTcType)
...
checkCmdGRHSs :: GRHSs RdrName (LHsExpr RdrName PreTcType) PreTcType -> P (GRHSs RdrName (LHsCmd RdrName PreTcType) PreTcType)
checkCmdGRHSs (GRHSs grhss binds) = do
    grhss' <- mapM checkCmdGRHS grhss
    return $ GRHSs grhss' binds

checkCmdGRHS :: LGRHS RdrName (LHsExpr RdrName PreTcType) PreTcType -> P (LGRHS RdrName (LHsCmd RdrName PreTcType) PreTcType)
...
cmdFail :: SrcSpan -> HsExpr RdrName PreTcType -> P a
cmdFail loc e = parseErrorSDoc loc (text "Parse error in command:" <+> ppr e)
cmdStmtFail :: SrcSpan -> Stmt RdrName (LHsExpr RdrName PreTcType) PreTcType -> P a
...
mkRecConstrOrUpdate
        :: LHsExpr RdrName PreTcType
        -> SrcSpan
        -> ([HsRecField RdrName (LHsExpr RdrName PreTcType)], Bool)
        -> P (HsExpr RdrName PreTcType)
...
mkImport :: CCallConv
         -> Safety
         -> (Located FastString, Located RdrName, LHsType RdrName PreTcType)
         -> P (HsDecl RdrName PreTcType)
