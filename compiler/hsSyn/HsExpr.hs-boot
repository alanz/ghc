...
instance (DataHsLitX x, DataId id) => Data (HsExpr x id)
instance (DataHsLitX x, DataId id) => Data (HsCmd x id)
...
instance (SourceTextX x, OutputableBndrId id) => Outputable (HsExpr x id)
instance (SourceTextX x, OutputableBndrId id) => Outputable (HsCmd x id)
