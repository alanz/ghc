...
data HsExpr id
  ...
  --           inactive 'HsSCC'
  --   - Note: if 'ApiAnnotation.AnnVal2' up to 'ApiAnnotation.AnnVal5' are
  --            present this is actually an
  --           inactive 'HsTickPragma'
...
--                                 -- a match that does the job
  ...
  -- | - 'ApiAnnotation.AnnKeywordId' : 'ApiAnnotation.AnnOpen',
  --         'ApiAnnotation.AnnOpen2','ApiAnnotation.AnnClose2',
  --         'ApiAnnotation.AnnClose'
